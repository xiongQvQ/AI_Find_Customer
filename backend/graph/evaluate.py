...
def should_continue_hunting(state: HuntState) -> str:
    ...
    3. Diminishing returns: new leads this round < min_threshold (default 5)
    ...
    # Threshold scales with target: 5% of target, min 3, max 10
    diminishing_threshold = max(3, min(10, int(target * 0.05)))
